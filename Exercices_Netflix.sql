...
-- Analyse du catalogue Netflix : Répartition annuelle des contenus ajoutés pour l'Inde

-- Étape 10 : Trouver pour chaque année le nombre de contenus ajoutés en Inde
-- et calculer leur pourcentage par rapport au total des contenus indiens
